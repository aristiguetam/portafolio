    ...
    return (
        <div id='contact' className=" bg-background-dark dark:bg-background-light h-[630px] flex flex-col justify-center items-center">
            <div className="justify-center items-center">
                ...
                <p className="px-4 md:px-0 text-sm font-medium sm:text-lg text-ellipsis text-center dark:text-[#2B2C34] text-[#FFFFFE] mt-2 sm:font-semibold">¿Tienes una idea genial que quieras llevar a cabo? Contáctame y hagamos realidad tu proyecto.</p>
            </div>
